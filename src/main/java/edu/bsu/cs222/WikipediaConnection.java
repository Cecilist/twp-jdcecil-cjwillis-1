...
public class WikipediaConnection {
    ...
    public InputStream Connection(String title, boolean GUI) throws IOException {
        try{
            ...
            if (GUI) {
                JOptionPane.showMessageDialog(null, "There was an error connecting to wikipedia " + error);
            }
            System.exit(3);
